...
<div class="result-card">
	...
	{#if $clipState.decryptedText}
		...
		<div class="result-actions">
			...
			<button class="btn-action" onclick={() => showShareModal = true} disabled={copyFeedback === 'link'}>
				<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
{#if showShareModal && $clipState.shareUrl}
	<ShareModal url={$clipState.shareUrl} onClose={() => showShareModal = false} />
{/if}
