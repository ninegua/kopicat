const WORDS = [
  ...
  'access','account','acid','acoustic','acquire','across','act','action','actor','actress',
  ...
  'air','airport','aisle','alarm','album','alcohol','alert','alien','align','alike',
  ...
  'arch','arctic','area','arena','argue','arm','armed','armor','army','arrange',
  ...
  'avoid','awake','aware','awesome','awful','awkward','axis','baby','bachelor','bacon',
  'badge','balance','balcony','ball','bamboo','banana','banner','bar','barely','bargain',
  'barrel','base','basic','basket','battle','beach','bean','beauty','because','become',
  'beef','before','begin','behave','behind','believe','below','belt','bench','benefit',
  'best','betray','better','between','beyond','bicycle','bid','bike','bind','biology',
  'bird','birth','bitter','black','blade','blame','blanket','blast','bleak','bless',
  'blind','blood','blossom','blow','blue','blur','blush','board','boat','body','bomb',
  ...
  'danger','daring','dash','daughter','dawn','deal','debate','debris','decade','december',
  ...
  'direct','dirt','disagree','describe','dispute','disease','dish','dismiss','disorder',
  ...
  'inflict','inform','inhale','inherit','initial','inject','inmate','inner','innocent',
  ...
  'never','news','next','nice','night','noble','noise','nominee','noodle','north',
  ...
  'olive','olympic','omit','once','one','onion','online','open','opera','opinion',
  ...
  'struggle','student','stuff','stumble','style','subject','submit','subtle','success',
  ...
  'topple','torment','tornado','tortoise','toss','total','tourist','toward','tower','town',
  ...
  'undo','unfair','unfold','unhappy','uniform','union','unique','unit','universe',
  ...
  'weird','welcome','west','whale','what','wheat','wheel','when','whip','whisper',
...
export function generateClipId(): string {
  ...
  const w1 = WORDS[a[0] % WORD_COUNT];
  const w2 = WORDS[a[1] % WORD_COUNT];
  const w3 = WORDS[a[2] % WORD_COUNT];
  return `${w1}-${w2}-${w3}`;
}
